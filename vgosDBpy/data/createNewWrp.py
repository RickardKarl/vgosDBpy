...
def create_new_wrapper(list_changed_files,new_file_names, path_to_old_wrp, new_wrp_name): #actuall path in computer mening wrpPath style
...
def test():
    ...
    new_names = ['Met_V001.nc', 'Head_v001.nc']
